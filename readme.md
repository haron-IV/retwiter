...
> Database have to be created at first call, but if it will not works create it by yourself, You can find instrunction in docs -> [Retwiter wiki][documentation-link]
```sh
